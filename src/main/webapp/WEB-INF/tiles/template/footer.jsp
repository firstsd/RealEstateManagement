...
<div class="container">
    <div class="row">
                ...
                <c:if test="${not empty sessionScope.currentUser}">
                    <c:choose>
                        <c:when test="${sessionScope.currentUser.role.id == 4}">
                            <li class="col-lg-12 col-sm-12 col-xs-3"><a href="<c:url value="/property/requests"/>">Pending
                                requests</a></li>
                        </c:when>
                    </c:choose>
                    <c:choose>
                        <c:when test="${sessionScope.currentUser.role.id != 1}">
                            <li class="col-lg-12 col-sm-12 col-xs-3"><a href="<c:url value="/bookappointment/list"/>">Appointments</a>
                            </li>
                        </c:when>
                    </c:choose>
        ...
        <div class="col-lg-4 col-sm-4">
            <h4>Contact us</h4>
            <p>
                <b>WAA @ Joe Bruen.</b><br> <span class="glyphicon glyphicon-map-marker"></span> 1000 N 4th St, IA, USA,
                52557 <br>
                <span class="glyphicon glyphicon-envelope"></span><a href="mailto:name@email.com"> waa@mum.edu</a><br>
                <span
