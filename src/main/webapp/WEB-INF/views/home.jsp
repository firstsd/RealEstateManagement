...
<div class="">
				...
				<div class="row">
					<div class="col-lg-6 col-sm-6">
						<form:form modelAttribute="searchDto"  role="form" 
							...
							<input type="text" class="form-control" name="textSearch" placeholder="Search of Properties">
							<div class="row">
								...
								<div class="col-lg-4 col-sm-5">
									<button type="submit" class="btn btn-primary col-lg-4 col-sm-5">Find Now</button>
								</div>
							</div>
							<input type="hidden" name="order" value="0"> <input type="hidden" name="currentPage" value="1">
						</form:form>
						<button type="button" id="searchBtnHome" class="btn btn-primary col-lg-4 col-sm-5">Find by Ajax</button>
					</div>
	...
	<div class="container">
		<div class="properties-listing spacer">
			<a href="<c:url value="property/list"/>" class="pull-right viewall"><spring:message code="allView.msg" text="View all listing" /></a>
				...
				<c:forEach var="property" items="${hotProperties}">
					...
					<div class="properties">
						<div class="image-holder">
							<img src="<c:url value="/uploadimage/${property.mainPicturePath}"/>" class="img-responsive" alt="properties-${property.mainPicturePath}">
							<c:choose>
					...
					<div id="myCarousel" class="carousel slide">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="row">
									<div class="col-lg-4">
										<img src="<c:url value="/resources/images/properties/1.jpg"/>" class="img-responsive" alt="properties" />
									</div>
									<div class="col-lg-8">
										<h5>
