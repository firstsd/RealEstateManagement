...
<tiles:insertDefinition name="baseLayout">
	...
	<div class="inside-banner">
		<div class="container">
			<span class="pull-right"><a href="<c:url value="/property/list"/>"><spring:message code="allView.msg" text="View All Listing" /></a> / Back</span>
			<h2>Buy / Rent</h2>
		</div>
	</div>
												...
												<div class="panel panel-default feedback">
													<div class="panel-heading feedback_header">
														(<b> <c:choose>
															...
															</c:choose></b>) - ${propertyFeedback.getAccount().getFirstName()}
										...
										<form id="feedbackFrm" class="" role="form" method="POST"
											...
											<div class="feedback">
												...
												<button id="sendMsgBtn" type="submit"
													class="btn btn-success" name="Submit">Send Message</button>
											</div>
										</form>
									</div>
									<!-- end of FEEDBACK -->
												...
												<c:choose>
													<c:when test="${property.getAgentAccount() != null}">
														...
														<p>
															...
															${property.getAgentAccount().getLastName()} <br>${property.getAgentAccount().getMobile()}
														</p>
													</c:when>
													<c:otherwise>
														<span class="glyphicon glyphicon-user"></span>Owner Details
														<p>
															...
															${property.getOwner().getLastName()} <br>${property.getOwner().getMobile()}
														</p>
													</c:otherwise>
												</c:choose>
											</div>
											...
											<c:choose>
												<c:when
													...
													<span id="listing-detail-add" data-toggle="tooltip"
														data-placement="bottom" data-original-title="Yard">${property.getYard()}</span>
												</c:when>
												<c:otherwise>
													<span id="listing-detail-add" data-toggle="tooltip"
														data-placement="bottom" data-original-title="Floor">${property.getFloor
														()}</span>
												</c:otherwise>
											</c:choose>
									...
									<div class="col-lg-12 col-sm-6 ">
										<div class="enquiry">
											...
											<form:form modelAttribute="bookAppointment"
												action="/RealEstateManagement/property/addAppointment" method="POST">
